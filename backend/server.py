...
MACHINE_DATA = {
    WorkingStep.BODENBEARBEITUNG: [
        ...
        },
        {
            ...
            "price_per_use": 1.00,
            "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.GERSTE, CropType.TRITICALE, CropType.SILOMAIS, CropType.ERBSEN, CropType.ZUCKERRUEBEN],
            "image_url": "https://images.pexels.com/photos/96417/pexels-photo-96417.jpeg"
        },
        {
            "id": "grubber_01",
    ...
    WorkingStep.AUSSAAT: [
        ...
        },
        {
            ...
            "price_per_use": 5.50,
            "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.GERSTE, CropType.TRITICALE, CropType.ERBSEN, CropType.SILOMAIS],
            "image_url": "https://images.pexels.com/photos/96417/pexels-photo-96417.jpeg"
        }
    ],
...
async def initialize_sample_data():
    ...
    machines_to_create = [
        ...
        {"id": "grubber_01", "name": "Grubber", "type": MachineType.GRUBBER, "description": "Bodenbearbeitungsgerät", "price_per_use": 1.20, "working_step": WorkingStep.BODENBEARBEITUNG, "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.GERSTE, CropType.TRITICALE, CropType.SILOMAIS, CropType.ERBSEN]},
        
        # Aussaat (2 machines)
        {"id": "horsch_pronto_6dc", "name": "Horsch Pronto 6 DC", "type": MachineType.SAEMASCHINE, "description": "Drillmaschine (6m Arbeitsbreite)", "price_per_use": 0.80, "working_step": WorkingStep.AUSSAAT, "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.GERSTE, CropType.TRITICALE, CropType.ERBSEN]},
        {"id": "traktor_john_deere_7820", "name": "John Deere 7820", "type": MachineType.TRAKTOR_AUSSAAT, "description": "Traktor für Aussaat", "price_per_use": 5.50, "working_step": WorkingStep.AUSSAAT, "suitable_for": [CropType.WINTERWEIZEN, CropType.ROGGEN, CropType.GERSTE, CropType.TRITICALE, CropType.ERBSEN, CropType.SILOMAIS]},
        
        # Pflanzenschutz (5 machines)
        {"id": "feldspritze_01", "name": "Feldspritze", "type": MachineType.FELDSPRITZE, "description": "Pflanzenschutzspritze", "price_per_use": 0.65, "working_step": WorkingStep.PFLANZENSCHUTZ, "suitable_for": [CropType.WINTERWEIZEN, CropType.ROGGEN, CropType.GERSTE, CropType.TRITICALE, CropType.SILOMAIS, CropType.ZUCKERRUEBEN, CropType.ERBSEN]},
        {"id": "traktor_john_deere_6r145", "name": "John Deere 6R145", "type": MachineType.TRAKTOR_PFLANZENSCHUTZ, "description": "Traktor für Pflanzenschutz", "price_per_use": 4.80, "working_step": WorkingStep.PFLANZENSCHUTZ, "suitable_for": [CropType.WINTERWEIZEN, CropType.ROGGEN, CropType.GERSTE, CropType.TRITICALE, CropType.SILOMAIS, CropType.ZUCKERRUEBEN, CropType.ERBSEN]},
