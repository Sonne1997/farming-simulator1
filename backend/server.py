...
MACHINE_DATA = {
    WorkingStep.BODENBEARBEITUNG: [
        ...
        },
        {
            ...
            "price_per_use": 1.00,
            "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.WINTERGERSTE, CropType.WINTERTRITICALE, CropType.SILOMAIS, CropType.ERBSEN, CropType.ZUCKERRUEBEN],
            "image_url": "https://images.pexels.com/photos/96417/pexels-photo-96417.jpeg"
        },
        {
            "id": "grubber_01",
            ...
            "price_per_use": 1.20,
            "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.WINTERGERSTE, CropType.WINTERTRITICALE, CropType.SILOMAIS, CropType.ERBSEN],
            "image_url": "https://images.pexels.com/photos/96417/pexels-photo-96417.jpeg"
        }
    ],
    WorkingStep.AUSSAAT: [
        {
            ...
            "price_per_use": 0.80,
            "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.WINTERGERSTE, CropType.WINTERTRITICALE, CropType.ERBSEN],
...
async def initialize_sample_data():
    ...
    machines_to_create = [
        ...
        # Pflege (2 machines)
        {"id": "cambridge_walze_01", "name": "Cambridge Walze", "type": MachineType.CAMBRIDGE_WALZE, "description": "Walze zur Bestockungsförderung", "price_per_use": 0.95, "working_step": WorkingStep.PFLEGE, "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.WINTERGERSTE, CropType.TRITICALE, CropType.ERBSEN]},
