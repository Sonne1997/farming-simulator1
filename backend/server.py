...
MACHINE_DATA = {
    WorkingStep.BODENBEARBEITUNG: [
        ...
        },
        {
            ...
            "price_per_use": 1.00,
            "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.WINTERGERSTE, CropType.TRITICALE, CropType.SILOMAIS, CropType.ERBSEN, CropType.ZUCKERRUEBEN],
            "image_url": "https://images.pexels.com/photos/96417/pexels-photo-96417.jpeg"
        },
        {
            "id": "grubber_01",
            ...
            "price_per_use": 1.20,
            "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.WINTERGERSTE, CropType.TRITICALE, CropType.SILOMAIS, CropType.ERBSEN],
            "image_url": "https://images.pexels.com/photos/96417/pexels-photo-96417.jpeg"
        }
    ],
    WorkingStep.AUSSAAT: [
...
async def initialize_sample_data():
    ...
    machines_to_create = [
        ...
        {"id": "hacke_01", "name": "Hacke", "type": MachineType.HACKE, "description": "Hackgerät für biologischen Anbau", "price_per_use": 1.15, "working_step": WorkingStep.PFLANZENSCHUTZ, "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.GERSTE, CropType.TRITICALE, CropType.SILOMAIS, CropType.ZUCKERRUEBEN, CropType.ERBSEN]},
