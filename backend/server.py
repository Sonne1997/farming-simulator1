...
async def initialize_sample_data():
    ...
    machines_to_create = [
        ...
        {"id": "feldspritze_herbizid_herbst", "name": "Feldspritze - Herbst Herbizid", "type": MachineType.FELDSPRITZE, "description": "Herbizid-Behandlung nach der Aussaat im Herbst", "price_per_use": 2.10, "working_step": WorkingStep.PFLANZENSCHUTZ, "season": "herbst", "treatment_type": "herbizid", "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.WINTERGERSTE, CropType.WINTERTRITICALE, CropType.WINTERRAPS]},
        ...
        {"id": "feldspritze_herbizid_fruejahr", "name": "Feldspritze - Frühjahr Herbizid", "type": MachineType.FELDSPRITZE, "description": "Herbizid-Behandlung im Frühjahr", "price_per_use": 2.30, "working_step": WorkingStep.PFLANZENSCHUTZ, "season": "fruejahr", "treatment_type": "herbizid", "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.WINTERGERSTE, CropType.WINTERTRITICALE, CropType.KHORASAN_WEIZEN, CropType.ERBSEN]},
        ...
        {"id": "feldspritze_insektizid", "name": "Feldspritze - Insektizid", "type": MachineType.FELDSPRITZE, "description": "Insektizid gegen Schädlinge", "price_per_use": 1.80, "working_step": WorkingStep.PFLANZENSCHUTZ, "season": "fruejahr", "treatment_type": "insektizid", "suitable_for": [CropType.WINTERWEIZEN, CropType.WINTERROGGEN, CropType.WINTERGERSTE, CropType.WINTERTRITICALE, CropType.KHORASAN_WEIZEN, CropType.SILOMAIS, CropType.ZUCKERRUEBEN, CropType.ERBSEN]},
